...
urlpatterns = [
    ...
    path(
        "admin/microarticles/import/",
        AdminCardImportView.as_view(),
        name="admin-microarticle-import",
    ),
    path(
    ...
    path(
        "decks/<int:deck_id>/cards/bulk-add/",
        DeckCardsBulkAddView.as_view(),
        name="deck-cards-bulk-add",
    ),
    path(
    ...
    path(
        "decks/<int:deck_id>/copy-to-user/",
        OfficialDeckCopyToUserView.as_view(),
        name="official-deck-copy-to-user",
    ),
